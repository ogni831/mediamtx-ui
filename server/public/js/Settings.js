...
export default class Settings {
    ...
    /**
     * Release event listeners. A fresh Settings instance is created on every
     * page (re)create, so this just drops references; without it, page.destroy()
     * throws on logout / re-login because settings.destroy() is undefined.
     */
    destroy() {
