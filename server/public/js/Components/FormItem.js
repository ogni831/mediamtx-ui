...
export default class FormItem extends Component {
    ...
    render() {
        ...
        // fall back to a plain text input when the value type can't be mapped
        // (e.g. a field returned as null/undefined by the API) so one unexpected
        // property never crashes the whole tab.
        const inputComponent = this.getInputComponent() || 'TextInput';
